...
ActiveRecord::Schema.define(:version => 20121010090556) do
  ...
  create_table "user_question_answer_details", :force => true do |t|
    t.integer  "user_id"
  ...
  create_table "user_submission_details", :force => true do |t|
    t.integer  "user_id"
